export const metadata = {
  title: 'Privacy Policy - paw.zr',
  description: 'Privacy Policy for paw.zr app',
};
        ...
        <div className="prose prose-gray max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Welcome to paw.zr (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). We are committed to protecting your privacy
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              ...
              <li>Pet information (names, species, breed, medical history)</li>
              <li>Government-issued ID for provider verification (Aadhaar)</li>
            </ul>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              ...
              <li>Connect pet owners with service providers</li>
              <li>Process transactions and bookings</li>
              <li>Verify service provider identities</li>
              <li>Send notifications about bookings and orders</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              ...
              <li><strong>Pet Suppliers:</strong> Shipping information for product orders</li>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">7. Location Data</h2>
            <p className="text-gray-700 mb-4">
              We collect location data to connect you with nearby service providers and for live
              tracking during pet care services. You can disable location access in your device settings,
