            ...
            {pending.map((booking) => (
              <Card key={booking.id}>
                ...
                <div className="mt-4 grid grid-cols-3 gap-4 text-sm">
                  ...
                  <div><p className="text-gray-500">Duration</p><p className="font-medium">{booking.duration} min</p></div>
                </div>
              ...
              <Card key={booking.id}>
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex gap-2">
                    <Button size="sm" onClick={() => startVideoCall(booking.id)}>Start Video Call</Button>
            ...
            {past.slice(0, 5).map((booking) => (
              <Card key={booking.id} className="opacity-75">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <Avatar src={booking.owner.avatar} name={booking.owner.name || ''} size="sm" />
                    <div>
                      <h3 className="font-medium">{booking.owner.name}</h3>
